...
t_ASSIGNMENTLEVELOP = r'''\=|\*\=|\/\='''

t_STRING_LITERAL = r'".*?"|"""\n(\s*).*\n(\s*)"""'

t_INT_LITERAL = r'0x[0-9a-fA-F][0-9a-fA-F_]*|0o[0-7][0-7_]*|0b[01][01_]*|[0-9][0-9_]*'

t_FLOAT_LITERAL = r'''0x[0-9A-Fa-f][0-9A-Fa-f_]*(\.[0-9A-Fa-f][0-9A-Fa-f_]*)?[pP][+-]?[0-9][0-9_]*|[0-9][0-9_]*[eE][+-]?[0-9][0-9_]*|[0-9][0-9]*\.[0-9][0-9_]*[eE][+-]?[0-9][0-9_]*|[0-9][0-9]_*\.[0-9][0-9_]*'''
